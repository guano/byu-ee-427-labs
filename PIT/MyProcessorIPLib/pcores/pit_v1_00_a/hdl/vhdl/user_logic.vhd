...
-- Date:              Wed Nov 02 16:29:35 2016 (by Create and Import Peripheral Wizard)
  ...
  begin
    ...
    if Bus2IP_Clk'event and Bus2IP_Clk = '1' then
      if Bus2IP_Resetn = '0' then
        --slv_reg0 <= (others => '0');
				slv_reg0 <= (others => '1');	-- counter resets to FF FF FF FF
				
        slv_reg1 <= (others => '0');	-- delay resets to 00 00 00 00
        slv_reg2 <= (others => '0');	-- control disables interrupts, does not load delay, and no decrement.
        slv_reg3 <= (others => '0');	-- register to store what the interrupt should be. (only use LSB)
      else
