...
#
#  File     top_level_ports_wave.tcl (Thu Nov 17 12:49:26 2016)
#
...
wave add $tbpath${ps}score_display_2_0_digit_0_pin -into $id 
wave add $tbpath${ps}score_display_2_0_digit_1_pin -into $id 
wave add $tbpath${ps}score_display_2_0_digit_2_pin -into $id 
wave add $tbpath${ps}score_display_2_0_digit_3_pin -into $id 
wave add $tbpath${ps}score_display_2_0_digit_4_pin -into $id 
wave add $tbpath${ps}score_display_2_0_digit_5_pin -into $id 
wave add $tbpath${ps}score_display_2_0_seg_a_pin -into $id 
wave add $tbpath${ps}score_display_2_0_seg_b_pin -into $id 
wave add $tbpath${ps}score_display_2_0_seg_c_pin -into $id 
wave add $tbpath${ps}score_display_2_0_seg_d_pin -into $id 
wave add $tbpath${ps}score_display_2_0_seg_e_pin -into $id 
wave add $tbpath${ps}score_display_2_0_seg_f_pin -into $id 
wave add $tbpath${ps}score_display_2_0_seg_g_pin -into $id 
