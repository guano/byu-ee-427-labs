...
Software: Xilinx EDK 13.2 or 13.3
...
2. Linux   - In order to install the files you must
             manually copy them to "<Xilinx_Install_Dir>\
             <EDK_Version>\ISE_DS\EDK\data\wizards\".