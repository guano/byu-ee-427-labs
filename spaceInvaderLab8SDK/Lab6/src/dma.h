/*****************************************************************************
* Filename:          C:\Users\superman\Desktop\lab8\SpaceInvadersHW_Pit_fit/drivers/dma_v1_00_a/src/dma.h
* Version:           1.00.a
...
#define DMA_SLV_REG8_OFFSET (DMA_USER_SLV_SPACE_OFFSET + 0x00000020)
#define DMA_SLV_REG9_OFFSET (DMA_USER_SLV_SPACE_OFFSET + 0x00000024)
...
#define DMA_mWriteSlaveReg8(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (DMA_SLV_REG8_OFFSET) + (RegOffset), (Xuint32)(Value))
#define DMA_mWriteSlaveReg9(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (DMA_SLV_REG9_OFFSET) + (RegOffset), (Xuint32)(Value))
...
#define DMA_mReadSlaveReg8(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (DMA_SLV_REG8_OFFSET) + (RegOffset))
#define DMA_mReadSlaveReg9(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (DMA_SLV_REG9_OFFSET) + (RegOffset))
...
void DMA_Init(Xuint32 BaseAddress, Xuint32 src, Xuint32 dest, Xuint32 length);
