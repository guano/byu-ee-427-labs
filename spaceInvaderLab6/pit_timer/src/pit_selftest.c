...
int main(){
	...
	PIT_mWriteSlaveReg0 (base, 1*4, 0x50000000);
	...
	PIT_mWriteSlaveReg0 (base, 2*4, 0x00000006);	// writing stuff to the control register - allowing decrement
	PIT_mWriteSlaveReg0 (base, 0*4, 0x00000001);	// writing stuff to the control register - allowing decrement
